...
### Features
- Drain the automerge queue one pull request at a time  ([#321](https://github.com/stateful-y/python-package-copier/pull/321)) by @gtauzin
...
### Features
- Land polish-changelog, allow re-sectioning, and exercise the release path  ([#266](https://github.com/stateful-y/python-package-copier/pull/266)) by @gtauzin
...
### Bug Fixes
- Make the cyclonedx-bom renovate annotation readable  ([#264](https://github.com/stateful-y/python-package-copier/pull/264)) by @gtauzin
...
### Bug Fixes
- Repair the release path and the checks that missed it  ([#260](https://github.com/stateful-y/python-package-copier/pull/260)) by @gtauzin

### Documentation
- Record the conflicted-.gitignore hazard from the v0.38.0 fan-out  ([#254](https://github.com/stateful-y/python-package-copier/pull/254)) by @gtauzin
...
### Features
- Make the template repo subject to the gates it ships  ([#252](https://github.com/stateful-y/python-package-copier/pull/252)) by @gtauzin
...
### Documentation
- Document signing release tags with gitsign  ([#250](https://github.com/stateful-y/python-package-copier/pull/250)) by @gtauzin
...
### Bug Fixes
- Broaden generated tests/** ruff S-ignore for common test patterns  ([#245](https://github.com/stateful-y/python-package-copier/pull/245)) by @gtauzin
...
### Features
- Add a user-facing security posture page  ([#243](https://github.com/stateful-y/python-package-copier/pull/243)) by @gtauzin
...
### Features
- Harden fleet security controls, visibility-gated  ([#241](https://github.com/stateful-y/python-package-copier/pull/241)) by @gtauzin
...
### Bug Fixes
- Persist renovate_preset and annotate every setup-uv pin  ([#233](https://github.com/stateful-y/python-package-copier/pull/233)) by @gtauzin
...
### Bug Fixes
- Restore bare site_name homepage title under Zensical  ([#228](https://github.com/stateful-y/python-package-copier/pull/228)) by @gtauzin
